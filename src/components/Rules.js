...
<ul className="text-center mx-auto  text-md space-y-3  pt-5 list-disc">
            ...
            <li>Summoning Phrases are familiar experiences that allow a psychic to quickly
                call upon their abilities. </li>
            <li>In an effort to please Claire and keep her engaged
                it is important to call her summoning phrase before each question.</li>
            <li>The summoning phrase is <span className="text-pink-500">"Claire Voyante, I call upon you:"</span> </li>
        </ul>
        </div>
